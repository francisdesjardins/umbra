      ...
      >
        <ExampleGrid columns={1}>
          ...
          <ExampleCard
            ...
            description="The panel-modal family, and the heaviest layout here: a truncating title, a jump-to dropdown, step navigation in a space-between footer, and two actions that deliberately do not close the modal."
