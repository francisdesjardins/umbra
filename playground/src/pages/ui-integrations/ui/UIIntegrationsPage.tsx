  ...
  return (
    <MuiIsland>
      <PageLayout
        ...
        description="The same headless hooks, twice — plain HTML/CSS on the left, Material UI (the exception) on the right. Compare the pairs to see exactly how little of the library is UI-aware."
      >
        <ExampleSection
          title="Message"
