...
import vanillaMsgDefaultLayoutSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaDefaultLayout.tsx?raw';
import vanillaMsgContainerSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaContainer.tsx?raw';
import vanillaMsgHeaderSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaHeader.tsx?raw';
import vanillaMsgTitleSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaTitle.tsx?raw';
import vanillaMsgIconSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaIcon.tsx?raw';
import vanillaMsgContentSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaContent.tsx?raw';
import vanillaMsgFooterSrc from '@/entities/modal-template/ui/vanilla/message-dialog/components/VanillaFooter.tsx?raw';
import vanillaMsgStylesSrc from '@/entities/modal-template/ui/vanilla/message-dialog/styles.module.css?raw';
import vanillaSlideDefaultLayoutSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaDefaultLayout.tsx?raw';
import vanillaSlideHeaderSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaHeader.tsx?raw';
import vanillaSlideTitleSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaTitle.tsx?raw';
import vanillaSlideContentSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaContent.tsx?raw';
import vanillaSlideFooterSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaFooter.tsx?raw';
import vanillaSlideButtonContainerSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaButtonContainer.tsx?raw';
import vanillaSlideCheckboxLabelSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaCheckboxLabel.tsx?raw';
import vanillaSlideSectionGroupSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/components/VanillaSectionGroup.tsx?raw';
import vanillaSlideStylesSrc from '@/entities/modal-template/ui/vanilla/slide-dialog/styles.module.css?raw';
import vanillaFormLayoutSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/VanillaFormLayout.tsx?raw';
import vanillaFormHeaderSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/Header.tsx?raw';
import vanillaFormContentSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/Content.tsx?raw';
import vanillaFormFooterSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/Footer.tsx?raw';
import vanillaFormFieldGroupSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/VanillaFieldGroup.tsx?raw';
import vanillaFormFieldErrorSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/VanillaFieldError.tsx?raw';
import vanillaFormInputSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/VanillaInput.tsx?raw';
import vanillaFormLabelSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/VanillaLabel.tsx?raw';
import vanillaFormButtonContainerSrc from '@/entities/modal-template/ui/vanilla/form-dialog/components/VanillaButtonContainer.tsx?raw';
import vanillaFormStylesSrc from '@/entities/modal-template/ui/vanilla/form-dialog/styles.module.css?raw';
import vanillaPanelPanelContainerSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/components/VanillaPanelContainer.tsx?raw';
import vanillaPanelPanelHeaderSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/components/VanillaPanelHeader.tsx?raw';
import vanillaPanelHeaderActionLayoutSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/components/VanillaHeaderActionLayout.tsx?raw';
import vanillaPanelPanelContentSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/components/VanillaPanelContent.tsx?raw';
import vanillaPanelPanelFooterSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/components/VanillaPanelFooter.tsx?raw';
import vanillaPanelDividerSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/components/VanillaPanelDivider.tsx?raw';
import vanillaPanelStylesSrc from '@/entities/modal-template/ui/vanilla/panel-dialog/styles.module.css?raw';
