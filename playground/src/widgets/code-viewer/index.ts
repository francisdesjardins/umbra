...
// **The hook is the whole surface.** `codeSamples` and `CodeDialogContent` are loaded on demand (the
// latter behind `React.lazy` in `ui/CodeDialogLazy`); re-exporting either statically makes it
