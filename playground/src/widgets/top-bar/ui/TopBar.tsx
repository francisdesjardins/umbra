      ...
      <div className={styles['toolbar']}>
        ...
        <Link to="/" aria-label="Umbra — home" className={styles['brand']}>
          {/* The flat mark, not the mascot and not a moon phase: the bar says what the product is,
              and it now says the same thing the browser tab does. `MoonPhase` keeps its real job
              as a heading ornament — a lunar phase is a different drawing from an eclipse, and
              having one in the badge and the other in the tab was the whole fragmentation. */}
          <EclipseMark size={26} />
