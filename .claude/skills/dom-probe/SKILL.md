...
node .claude/skills/dom-probe/probe.mjs --url http://127.0.0.1:4403/priorx \
  ...
  --do "settle:dialog[data-testid='modal-direct-message-modal']" \
  --probe "toplayer:dialog[data-testid='modal-direct-message-modal']" \
  --probe "at:20,20"
...
- `dialog-debug` — the slide-modal configurator specifically, with per-frame motion measurement.
