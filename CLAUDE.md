...
(`CT_COVERAGE=1`) because instrumentation costs about 45% of the run. Measured 2026-08-28: **91.60% over 55 files**, against unit's **96.56%**. Never add them; re-measure both or neither — **and the
