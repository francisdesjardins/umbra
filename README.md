...
[![Component coverage](https://img.shields.io/badge/component_coverage-91%25-3fb950?style=flat-square)](#development)
...
half.** `yarn test:unit:coverage` measures the framework-free core in Node (c8) — **96.59%**
...
~45% of the run) — **91.41%** statements over 55 files. Both measured 2026-08-29, and re-measured
