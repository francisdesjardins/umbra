...
half.** `yarn test:unit:coverage` measures the framework-free core in Node (c8) — **96.62%**
...
~45% of the run) — **92.18%** statements over 56 files. Both measured 2026-08-30, and re-measured
