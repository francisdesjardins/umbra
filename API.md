...
| reconcileOpen                                | ✓                                                                                                                                                                      | ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | ✓ — Read off the snapshot the controller publishes rather than through `useLookup`, which is why `phase` is on this binding’s surface and on neither of the others. The `phase`-versus-`isVisible` half is proven on React only: moving the decision to `isVisible` fails there and does not here, and why it does not is unexplained rather than accounted for. |
