...
| focus restored after a failed action         | ✓                                                                                                                                                                                    | ✓ untested                                                                                                                                  | ✓ — Reads `focusin` rather than `activeElement`, because this binding’s own `bindAction` disables the button synchronously first.                                                 |
| the labelling diagnostic                     | ✓                                                                                                                                                                                    | ✓                                                                                                                                           | ✓                                                                                                                                                                                 |
| onOpenRequest                                | ✓                                                                                                                                                                                    | ✓ untested                                                                                                                                  | ✓                                                                                                                                                                                 |
| containFocus                                 | ✓                                                                                                                                                                                    | ✓ untested                                                                                                                                  | ✓ untested                                                                                                                                                                        |
| dismissOnClickOutside                        | ✓                                                                                                                                                                                    | ✓ untested                                                                                                                                  | ✓ untested                                                                                                                                                                        |
| dismissOnBackdropClick                       | ✓                                                                                                                                                                                    | ✓ — Reached through the `undeclare` test, which asserts dismissal coming back.                                                              | ✓                                                                                                                                                                                 |
| a custom dismissKey                          | ✓                                                                                                                                                                                    | ✓ untested — Escape is exercised; a non-default key is not.                                                                                 | ✓ untested                                                                                                                                                                        |
| prepare aborted by a close                   | ✓                                                                                                                                                                                    | ✓ untested                                                                                                                                  | ✓                                                                                                                                                                                 |
| reconcileOpen                                | ✓ untested — Exported from the root with a unit test over the decision, and exercised by no binding at all — it is the helper a caller uses to drive a modal from their own boolean. | ✓ untested                                                                                                                                  | ✓ untested                                                                                                                                                                        |
...
| Escape is always answered by someone                         | ✓ untested  | A non-modal panel answers through `attachWindowDismissKey` wherever focus is; a modal one answers through its own scoped keydown and the native `cancel`. Each half is tested. The intersection — a non-modal panel standing down while the modal in front has `dismissKey: false` — is not, and in it nobody answers.                                               |
