...
/**
 * Find the button wired to a hotkey (via its `aria-keyshortcuts` label) inside
 * `root`, then focus and click it — dispatching the action through the same
 * path as a real click.
 *
 * @internal
 */
